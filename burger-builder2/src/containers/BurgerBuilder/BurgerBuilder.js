        ...
        return(
            <Aux>
                <Modal  show={this.state.purchasing} modalClosed={this.pruchaseCancelHandler}>
                    <OrderSummary price={this.state.totalPrice} purchasedContinue={this.purchasedContinueHandler} purchasedCancel={this.pruchaseCancelHandler}ingredients={this.state.ingredients}/>
                </Modal>
